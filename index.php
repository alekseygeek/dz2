...
$names = "Alex";
$prof = "businessman";
$cityCountry = "Дом на_берегу_моря";
$email = "vcb1990@rambler.com";
$phone = "+188843567821";
 $works =[
    [
        "name" => "хозяин",
        ...
        "description" => "хозяин компании",
    ],
    [
        "name" => "бугалтер",
        "dateStart" => "март 2014",
        "dateEnd" => "март 2013",
        "description" => "считал денюшку",
    ],
    [
        "name" => "наёмник",
        "dateStart" => "март 2012",
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <?php for ($i = 0; $i < count($works); $i++): ?>
                        <div class="w3-container">
                            ...
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $works[$i]['dateStart'];?> - <span
                                    class="w3-tag w3-teal w3-round"><?= $works[$i]['dateEnd'];?></span></h6>
                    ...
                    <div class="w3-container w3-card w3-white">
                        ...
                        <div class="w3-container">
                            <h5 class="w3-opacity"><b>sam.ru</b></h5>
